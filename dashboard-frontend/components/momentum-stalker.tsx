...
export function MomentumStalker({ data }: MomentumStalkerProps) {
    ...
    return (
        <div className="h-full flex flex-col gap-4 font-mono group">
            ...
            <div className="flex-1 bg-slate-900/50 border border-white/5 rounded-sm p-6 flex flex-col justify-center gap-8 relative overflow-hidden">
                {/* Decorative Grid */}
                ...
                <div className="relative z-10 bg-black/40 border border-white/5 p-3 rounded-sm">
                    <div className="flex items-center gap-3 text-[10px]">
                        <div className={`h-2 w-2 rounded-full ${isStalking ? 'bg-emerald-500 animate-pulse' : 'bg-slate-700'}`} />
