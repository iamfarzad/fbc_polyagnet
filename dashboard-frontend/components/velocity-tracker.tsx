...
export function VelocityTracker({ tradeCount, dailyGoal = 100 }: VelocityTrackerProps) {
    ...
    return (
        <div className="space-y-4 font-mono">
            ...
            <div className="bg-card border border-border/40 p-4 rounded-sm space-y-4 shadow-inner relative overflow-hidden group hover:border-emerald-500/20 transition-colors">
                ...
                <div className="h-1 w-full bg-muted/30 rounded-full overflow-hidden relative z-10 border border-border/40">
                    <div
